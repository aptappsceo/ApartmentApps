...
namespace ApartmentApps.Client
{
    internal partial class Maitenance : IServiceOperations<ApartmentAppsAPIService>, IMaitenance
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<IList<MaintenanceIndexBindingModel>>> ListRequestsWithOperationResponseAsync(CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
            bool shouldTrace = ServiceClientTracing.IsEnabled;
            string invocationId = null;
            ...
            // Create Result
            HttpOperationResponse<IList<MaintenanceIndexBindingModel>> result = new HttpOperationResponse<IList<MaintenanceIndexBindingModel>>();
            result.Request = httpRequest;
            result.Response = httpResponse;
            ...
            if (statusCode == HttpStatusCode.OK)
            {
                IList<MaintenanceIndexBindingModel> resultModel = new List<MaintenanceIndexBindingModel>();
                JToken responseDoc = null;
                if (string.IsNullOrEmpty(responseContent) == false)
                {
                    responseDoc = JToken.Parse(responseContent);
                ...
                if (responseDoc != null)
                {
                    resultModel = MaintenanceIndexBindingModelCollection.DeserializeJson(responseDoc);
                }
                result.Body = resultModel;
            }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<object>> ScheduleRequestWithOperationResponseAsync(int id, DateTimeOffset scheduleDate, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
            bool shouldTrace = ServiceClientTracing.IsEnabled;
            string invocationId = null;
            if (shouldTrace)
            {
                ...
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("id", id);
                tracingParameters.Add("scheduleDate", scheduleDate);
                ServiceClientTracing.Enter(invocationId, this, "ScheduleRequestAsync", tracingParameters);
            }
            
            // Construct URL
            string url = "";
            url = url + "/api/Maitenance/ScheduleRequest";
            List<string> queryParameters = new List<string>();
            queryParameters.Add("id=" + Uri.EscapeDataString(id.ToString()));
            queryParameters.Add("scheduleDate=" + Uri.EscapeDataString(scheduleDate.ToString()));
            if (queryParameters.Count > 0)
            {
                url = url + "?" + string.Join("&", queryParameters);
            }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<object>> StartRequestWithOperationResponseAsync(int id, string comments, IList<string> images, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (comments == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("comments", comments);
                tracingParameters.Add("images", images);
                ServiceClientTracing.Enter(invocationId, this, "StartRequestAsync", tracingParameters);
            }
            
            // Construct URL
            string url = "";
            url = url + "/api/Maitenance/StartRequest";
            List<string> queryParameters = new List<string>();
            queryParameters.Add("id=" + Uri.EscapeDataString(id.ToString()));
            queryParameters.Add("comments=" + Uri.EscapeDataString(comments));
            if (queryParameters.Count > 0)
