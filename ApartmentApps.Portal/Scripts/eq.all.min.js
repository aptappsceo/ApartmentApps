...
(function(d, c) {
    ...
    var a = {
        ...
        RootPredicateTitle: "Filter where {lt} apply",
        StrAddConditions: "Add Filter",
    ...
    b.core.DataModel.prototype = {
        ...
        getFullEntityPathByAttr: function(f, e) {
            e = e || " ";
            return this.getEntityPathByAttr(this.getRootEntity(), f, e, true)
        },
        getEntityPathByAttr: function(f, h, o, l) {
            if (!f) {
                return ""
            }
            o = o || " ";
            ...
            if (f.subEntities) {
                ...
                for (n = 0; n < g; n++) {
                    var k = f.subEntities[n];
                    var j = this.getEntityPathByAttr(k, h, o, false);
                    if (j !== "") {
                        if (m !== "") {
                            j = m + o + j
                        }
        ...
        _listByEntity: function(k, f) {
            ...
            var r = null;
            if (k.subEntities) {
                var l = k.subEntities.length;
                for (var g = 0; g < l; g++) {
                    r = k.subEntities[g];
                    if (f.addUIC !== false && r.uic !== false || f.addUIR !== false && r.uir !== false || f.addUIS !== false && r.uis !== false) {
                        s = b.core.getText("Entities", r.name);
                        if (!s) {
                            s = r.caption
                        }
                        var o = {
                        ...
                        var n = d.extend({}, f);
                        n.includeRootData = false;
                        o.items = this._listByEntity(r, n);
                        q.push(o)
                    }
                }
            }
            var m = null;
            if (k.attributes) {
                var i = k.attributes.length;
                for (var h = 0; h < i; h++) {
                    m = k.attributes[h];
                    if (f.addUIC !== false && m.uic !== false || f.addUIR !== false && m.uir !== false || f.addUIS !== false && m.uis !== false) {
                        s = b.core.getText("Attributes", m.id);
                        if (!s) {
                            s = m.caption
                        }
                        j.push({
            ...
            function e(v, u) {
                if (v.text.toLowerCase() == u.text.toLowerCase()) {
                    return 0
                }
                if (v.text.toLowerCase() > u.text.toLowerCase()) {
                    return 1
            ...
            var t;
            if (!f.attrPlacement || f.attrPlacement == 0) {
                t = q.concat(j)
            } else {
                t = j.concat(q)
            }
            if (f.attrPlacement == 2) {
                t.sort(e)
            }
            if (f.includeRootData) {
                s = b.core.getText("Entities", k.name);
                if (!s) {
                    s = k.caption
                }
                return {
    ...
    b.core.Query.prototype = {
        ...
        moveColumn: function(i, h, g) {
            var e = this.getColumns();
            var f = e[i];
            b.core.moveArrayItem(e, i, h);
            this.fireChangedEvent({
                source: g,
        ...
        _getListFromCache: function(f) {
            var e = f.listName == "SQL" ? "SQL_" + f.editorId : f.listName;
            return this._listCache[e]
        },
        _addListToCache: function(g, f) {
            var e = g.listName == "SQL" ? "SQL_" + g.editorId : g.listName;
            this._listCache[e] = f
        },
        ...
        fireChangedEvent: function(g, e) {
            if (!this.isUpdating()) {
                g = g || {};
                g.query = this;
                var f = this;
                if (e) {
                    this._queryChangedCallbacks.fire(g)
                } else {
                    setTimeout(function() {
                        f._queryChangedCallbacks.fire(g)
                    }, 50)
                }
            }
        },
...
(function(f, g) {
    ...
    a.prototype = {
        ...
        showAt: function(s, q, t, o) {
            ...
            if (o) {
                f(this.levelDiv).css("visibility", "hidden")
            }
            r.display = "block";
            r.left = s + "px";
            r.top = q + "px";
            ...
            var n = d();
            var u = n.height - (q - e().top) - 15;
            if (this.parentMenu.maxHeight > 0 && u > this.parentMenu.maxHeight) {
                u = this.parentMenu.maxHeight
            }
            if (this.applyItem != null && this.applyItem.itemDiv != null) {
                u -= this.applyItem.itemDiv.offsetHeight + 5
            }
            if (this.searchDiv != null) {
                u -= this.searchDiv.offsetHeight
            }
            if (this.levelDiv.offsetHeight > u) {
                var j = u;
                if (j < 50) {
                    j = 50
                }
        ...
        showSubLevel: function(n) {
            ...
            var q = h(n.itemDiv, this.parentElement);
            var j = e();
            var k = d();
            var o = q.x - j.left;
            var i = k.width - o - n.itemDiv.offsetWidth;
            var l = q.x;
            q.x += n.itemDiv.offsetParent.offsetWidth;
            q.y += 1;
            n.subLevel.showAt(q.x, q.y, true, true);
            n.subLevel.levelDiv.style.width = "";
            n.subLevel.levelDiv.style.right = "";
            if ((i >= n.subLevel.levelDiv.offsetWidth) || (i >= o)) {
                if (i < n.subLevel.levelDiv.offsetWidth) {
                    n.subLevel.levelDiv.style.right = -j.left + "px"
                }
            } else {
                if (o < n.subLevel.levelDiv.offsetWidth) {
                    n.subLevel.levelDiv.style.left = j.left + 4 + "px"
                } else {
                    n.subLevel.levelDiv.style.left = ""
                }
                n.subLevel.levelDiv.style.right = f(window).width() - q.x + n.itemDiv.offsetWidth - 6 + "px"
            }
            f(n.subLevel.levelDiv).css("visibility", "visible");
            n.subLevel.focus()
        },
        ...
        renderContent: function() {
            ...
            this.scrollDiv = n;
            if (this.menuId) {
                f(this.levelDiv).attr("id", this.menuId)
            }
            this._renderItems();
        ...
        _renderItems: function(r) {
            ...
            for (A = 0; A < C; A++) {
                ...
                if (this.domWriteItemsId && this.menuId) {
                    f(q).attr("id", "item-" + this.menuId + "-" + D.id)
                }
                k.appendChild(q);
                q.menuItem = D;
                D.itemDiv = q;
                ...
                if (D.text == "---") {
                    ...
                    f(q).mouseenter(function() {
                        var i = this.menuItem;
                        x.parentMenu.isCursorInside = true;
                        if (B) {
                            x.activateItem(i)
                        }
                    });
                    f(q).mouseleave(function() {
                        var i = this.menuItem;
                        x.parentMenu.isCursorInside = false;
                        setTimeout(function() {
                            if (!x.parentMenu.isCursorInside) {
    ...
    function a(i) {
        ...
        this.levelDiv = null;
        this.domWriteItemsId = i.domWriteItemsId || false;
    ...
    f.widget("eqjs.PopupMenu", {
        ...
        showMenu: function(v) {
            ...
            u._itemSelectedCallback = v.itemSelectedCallback || null;
            u._menuClosedCallback = v.menuClosedCallback || null;
            u._itemFilterCallback = v.itemFilterCallback || null;
            var o = v.selectedIds || null;
            if (o) {
                if (typeof o === "string") {
                    o = o.split(",")
                }
            ...
            this.active = true;
            this._setSelectedItems(u.options.items, o);
            var m = v.anchor || document.documentElement;
            var l = h(m.get(0), this.options.container);
            var s = m.outerHeight(true);
            var i = m.outerWidth(true);
            var r = {
                x: l.x,
                y: l.y + s + 2
            };
            ...
            var j = r.x;
            r.x += 2;
            u._rootLevel.showAt(r.x, r.y, false, true);
            u._rootLevel.levelDiv.style.width = "";
            u._rootLevel.levelDiv.style.right = "";
            if ((q >= u._rootLevel.levelDiv.offsetWidth) || (q >= k)) {
                if (q < u._rootLevel.levelDiv.offsetWidth) {
                    u._rootLevel.levelDiv.style.right = -t.left + "px"
                }
            } else {
                if (k < u._rootLevel.levelDiv.offsetWidth) {
                    u._rootLevel.levelDiv.style.left = t.left + 4 + "px"
                } else {
                    u._rootLevel.levelDiv.style.left = ""
                }
                u._rootLevel.levelDiv.style.right = f(window).width() - r.x - i + "px"
            }
            f(u._rootLevel.levelDiv).css("visibility", "visible");
            u._rootLevel.focus();
...
(function(c, b) {
    ...
    a.client = {
        ...
        init: function(l) {
            ...
            if (l.defaultQueryId) {
                this.defaultQuery.setId(l.defaultQueryId)
            }
            ...
            if (l.loadQueryOnStart) {
                this.loadDefaultQuery = l.loadQueryOnStart
            }
            if (l.loadDefaultQuery) {
                this.loadDefaultQuery = l.loadDefaultQuery
            }
        ...
        saveQuery: function(e) {
            e = e || {};
            var f = e.query || this.getQuery();
            var g;
            if (f) {
                g = e.queryName || f.getName();
                if (e.queryId) {
                    f.setId(e.queryId)
                }
                var d = this._addAntiForgeryToken({
    ...
    a.widget("eqjs.ConditionRow_SMPL", a.eqjs.ConditionRow, {
        _postRender: function() {
            if (this.options.queryPanel.options.spreadValueElement) {
                var h = this.element.find(".eqjs-qp-valueelement");
                if (h.length == 0) {
                    return
                }
                var c = this.element.find(".eqjs-qp-condelement");
                var g = 0;
                for (var d = 0; d < c.length; d++) {
                    if (!a(c[d]).hasClass("eqjs-qp-valueelement")) {
                        g = g + a(c[d]).outerWidth(true)
                    }
                }
                var f = a(h[0]).outerWidth(true) - a(h[0]).width();
                g = g + this._buttonsBlock.width() + h.length * f;
                var e = this.element.width() - g;
                for (var d = 0; d < h.length; d++) {
                    a(h[d]).css("max-width", (e / h.length >> 0) + "px")
                }
            }
        },
        _refreshByCondition: function() {
            ...
            for (var l = 0; l < k; l++) {
                ...
                if (o.type === "operator") {
                    ...
                    if (o.type === "expression") {
                        if (o.index === 0) {
                            var i = this._createAttrElement(this._condition.expressions[0], function(t, u) {
                                var r = t.operators[0];
                                var s = q._condition.operatorID;
                                q._condition.operatorID = r;
                                q._updateValueExpressions(s, u)
                            });
                        ...
                        if (o.type === "text") {
                            var m = a("<span></span>").addClass("eqjs-qp-condelement").text(o.text).attr("title", o.text).appendTo(this.element)
                        }
                    }
                }
            }
        ...
        _createAttrElement: function(g, i) {
            ...
            if (this._condition.enabled !== false && !this._condition.readOnly) {
                ...
                c.attr("title", attrText);
                c.click(function(l) {
                    l.preventDefault();
                    k.options.queryPanel.showEntitiesMenu({
                        anchor: c,
                        selectedIds: null,
                        itemSelectedCallback: function(m, o) {
                            var q = o.menuItem.data("id");
                            var n = k.getModel().getAttributeById(q);
                            g.id = q;
                            if (i) {
                                i(n, d)
                            }
        ...
        _updateValueExpressions: function(t, m) {
            var u = this;
            var d = u._condition.expressions[0].id;
            var e = this.getModel().getAttributeById(d);
            if (!e) {
                return
            }
            var c = u._condition.operatorID;
            var f = this.getModel().getOperatorById(c);
            if (!f) {
                return
            }
            var h = u._condition.expressions.length;
            var o;
            var l;
            var q;
            if (t) {
                l = this.getModel().getOperatorById(t)
            }
            var k = 1;
            while (k < f.paramCount) {
                o = u.getModel().getOperand(e, f, k);
                if (l) {
                    q = u.getModel().getOperand(e, l, k)
                }
                if (!o.dataType || o.dataType == "Unknown") {
                    o.dataType = e.dataType
                }
                if (k >= h) {
                    u._condition.expressions.push(u._createValueExpression(o))
                } else {
                    var s = a.extend({}, u._condition.expressions[k]);
                    var j = u._createValueExpression(o);
                    var g;
                    if (q) {
                        g = u._createValueExpression(q).value
                    }
                    u._condition.expressions[k] = j;
                    var n = u._getExprEditor(s, k, t, m);
                    var r = u._getExprEditor(j, k);
                    if ((!g || g != s.value) && u._areCompatibleEditors(n, r)) {
                        u._tryToAssignExprValue(j, s)
                    }
                }
                k++
            }
            if (h > k) {
                u._condition.expressions.splice(k, h - k)
            }
        },
        ...
        _createOperatorsMenu: function(e) {
            var k = this;
            if (!k._condition || !k.getModel()) {
                return
            }
            var h = [];
            var f = k.getModel().getAttributeById(k._condition.expressions[0].id);
            if (f) {
                var d = null;
                var c = f.operators.length;
                for (var j = 0; j < c; j++) {
                    d = k.getModel().findOperatorById(f.operators[j]);
                    if (d && !(k.options.queryPanel.options.isSubQuery && d.kind === "Query")) {
                        var l = k._getOperatorCaption(d);
                        h.push({
                            id: d.id,
                            text: l
                        })
            ...
            var i = a("<div></div>").appendTo(e.parent()).hide();
            var g = k.element.attr("id");
            if (g) {
                g += "-OperatorsMenu"
            }
            i.PopupMenu({
                items: h,
                id: g,
                domWriteItemsId: k.options.queryPanel.options.domWriteItemsId,
                onMenuItemSelected: function(m, o) {
                    e.text(o.menuItem.text);
                    var n = k._condition.operatorID;
                    k._condition.operatorID = o.menuItem.id;
                    k._operatorChanged(n, k._condition.operatorID);
                    return false
                }
            });
            return i
        },
        _getExprEditor: function(j, e, d, i) {
            var h = i || this._condition.expressions[0].id;
        ...
        _createValueEditor: function(f, i, d) {
            ...
            if (h) {
                var g = "element.ValueEditor_" + h.type + "({parentWidget:self, editor: editorObj, onChange:exprChangedCallback}); element.ValueEditor_" + h.type + "('init', expr);";
                var j = new Function("self, element, expr, editorObj, exprChangedCallback", g);
                var e = function() {
                    var k = c.getModel();
                    var n = k.getOperatorById(c._condition.operatorID);
                    if (n.isRange) {
                        var m = c._condition.expressions[1];
                        var l = c._condition.expressions[2];
                        if (c._compareExpressions(m, l) > 0) {
                            if (m == i) {
                                c._copyExpr(m, l)
                            } else {
                                c._copyExpr(l, m)
        ...
        _compareExpressions: function(h, g) {
            var f, e, d = h.dataType,
                c = this.getModel();
            if (d === "Date" || d === "DateTime") {
                f = c.getDateOrMacroDateValue(h.value);
                e = c.getDateOrMacroDateValue(g.value);
                return f >= e ? 1 : -1
            } else {
                if (d === "Time") {
                    f = c.getTimeOrMacroTimeValue(h.value);
                    e = c.getTimeOrMacroTimeValue(g.value);
                    return f >= e ? 1 : -1
                } else {
                    if (d === "Int" || d === "Int32" || d === "Int64" || d === "Byte" || d === "Word") {
                        f = h.value !== "" ? parseInt(h.value) : 0;
                        e = g.value !== "" ? parseInt(g.value) : 0;
                        return f - e
                    } else {
                        if (d === "Float" || d === "Currency") {
                            f = h.value !== "" ? parseFloat(h.value) : 0;
                            e = g.value !== "" ? parseFloat(g.value) : 0;
                            return f - e
                        }
                    }
                }
...
(function(a, b) {
    a.widget("eqjs.ConditionRow_PDCT", a.eqjs.ConditionRow, {
        ...
        addCondition: function(f, d) {
            var c = this;
            if (!f || (a.isArray(f) && f.length == 0)) {
                return
            }
            if (typeof d == "number") {
                c._condition.conditions.push.apply(c._condition.conditions, [d, 0].concat(f))
            } else {
                c._condition.conditions.push.apply(c._condition.conditions, [].concat(f))
            }
            var e = [].concat(f);
            ...
            f.initAsActive = true;
            c.refresh();
            c._fireConditionChange("add", f)
        },
        trySetBlockId: function(d) {
            var c = (d.typeName == "PDCT") ? this.getQueryPanel().getNewPredId() : this.getQueryPanel().getNewCondId();
            if (c) {
                d.blockId = c
            }
        },
        ...
        addNewPredicate: function() {
            ...
            var i = {
                blockId: f.getQueryPanel().getNewCondId(),
                justAdded: true,
                typeName: "SMPL",
                enabled: true,
                operatorID: e,
    ...
    a.widget("eqjs.QueryPanel", {
        ...
        _render: function() {
            ...
            if (!e.isModelNullOrEmpty()) {
                e.options.entitiesList = e.getEntitiesList({
                    ...
                    addUIR: false,
                    addUIS: false,
                    attrPlacement: e.options.attrPlacement,
                    sortEntities: e.options.sortEntities
                });
                e.options.entitiesMenu = e._createEntitiesMenu();
                var g = a("<div></div>");
                if (e.element.attr("id")) {
                    g.attr("id", e.element.attr("id") + "-pred-root")
                }
        ...
        _createEntitiesMenu: function() {
            ...
            var d = {
                ...
                id: f,
                domWriteItemsId: c.options.domWriteItemsId
            };
    ...
    a.widget("eqjs.ValueEditor", {
        ...
        _render: function() {
            ...
            if (this.getModel() && this._expr) {
                ...
                this._renderEditor();
                if (this.getQueryPanel().options.spreadValueElement) {
...
(function(a, b) {
    a.widget("eqjs.ValueEditor_EDIT", a.eqjs.ValueEditor, {
        ...
        _showEditor: function() {
            var c = this;
            var d = c.element.width();
            c._linkElement.hide();
            c._editBox.val(c._getText()).css("min-width", d).show().focus()
        }
    })
})(jQuery);
(function(a, b) {
    a.widget("eqjs.ValueEditor_DATETIME", a.eqjs.ValueEditor_EDIT, {
        ...
        _create: function() {
            ...
            if (c) {
                ...
                if (c.options.yearRange) {
                    this._yearRange = c.options.yearRange
                }
            }
        ...
        _renderEditor: function() {
            ...
            if (c._expr.dataType == "Time") {
                ...
                if (c._expr.dataType == "Date") {
                    ...
                    if (c._yearRange) {
                        c._editBox.datepicker("option", "yearRange", c._yearRange)
                    } else {
                        c._yearRange = c._editBox.datepicker("option", "yearRange")
                    }
                } else {
        ...
        _convertDateValueString: function(g, i, h) {
            var d = this.getModel();
            var f = "${Today}";
            if (d && (a.inArray(g, d.dateMacroList) >= 0)) {
                var c = g.substring(2, g.length - 1);
                var e = this.getResText(c);
                return e ? e : f
            } else {
                var e = this._convertDateString(g, i, h);
                return e ? e : f
            }
        },
        ...
        _convertTimeValueString: function(f, h, g) {
            ...
            if (d && (a.inArray(f, d.timeMacroList) >= 0)) {
                ...
                var e = this._convertTimeString(f, h, g);
                return e ? e : ""
            }
        },
        _convertTimeString: function(e, g, f) {
            try {
                ...
                return c ? a.datepicker.formatTime(f, c) : ""
            } catch (d) {
                return ""
            }
        }
    ...
    a.widget("eqjs.ValueEditor_LIST", a.eqjs.ValueEditor, {
        ...
        _renderMenuBlock: function() {
            ...
            var d = {
                ...
                onMenuItemSelected: function(h, m) {
                    if (!f) {
                        c._setValue(m.menuItem.id)
                    } else {
                        if (m.selectedItems) {
                            var j = [];
                            var l = m.selectedItems.length;
                            for (var k = 0; k < l; k++) {
                                j.push(m.selectedItems[k].id)
                            }
                            c._setValue(j)
                        }
                    }
            ...
            var g = c.options.parentWidget.element.attr("id");
            if (g) {
                d.id = g + "-EditorMenu"
            }
            d.domWriteItemsId = e.options.domWriteItemsId;
            d.buttons = {
                submit: EQ.core.getText("ButtonApply"),
                cancel: EQ.core.getText("ButtonCancel")
            };
        ...
        _showEditor: function() {
            ...
            if (c._menuBlock) {
                this._menuBlock.PopupMenu("showMenu", {
                    ...
                    selectedIds: c._getValueAsArray()
                })
            } else {
                this._showWhenReady = true
            }
        ...
        _adjustNewValue: function(d) {
            if (a.isArray(d)) {
                var c = a.map(d, function(e) {
                    if (e.indexOf(",") >= 0) {
                        e = e.replace(/"/g, '"');
                        return '"' + e + '"'
                    } else {
...
(function(a, b) {
    a.widget("eqjs.ValueEditor_SQLLIST", a.eqjs.ValueEditor_CUSTOMLIST, {
        _fillMenuItemsList: function(h) {
            var d = this;
            var g = this.getQuery();
            var f = this.options.editor;
            var c = g.getListRequestHandler();
            if (c) {
                var e = {
                    listName: "SQL",
                    editorId: f.id
...
(function(a, b) {
    a.widget("eqjs.ValueEditor_SUBQUERY", a.eqjs.ValueEditor, {
        ...
        _renderEditor: function() {
            var m = this;
            m._dialogBlock = a("<div></div>", {
                "class": "eqjs-qp-ve-subquery"
            }).hide().appendTo(m.element);
            var k = this.getQueryPanel();
            var f = this.getModel();
            var h = f.getEntitiesTreeWithFilter(function(n) {
                if (n.attributes && n.uic) {
                    return true
                }
                return n.uic && (!n.dataType || n.dataType == m._expr.dataType)
            });
            var d = a("<div></div>").hide().appendTo(m._dialogBlock);
            var i = m.options.parentWidget.element.attr("id");
            if (i) {
                i += "-SubColumnMenu"
            }
            d.PopupMenu({
                items: h,
                zIndex: k.options.dialogZIndex + 1000,
                id: i,
                domWriteItemsId: k.options.domWriteItemsId
            });
            var e = a("<div></div>").addClass("eqjs-qp-ve-subquery-column").appendTo(m._dialogBlock);
            var l = a("<div></div>").addClass("eqjs-qp-ve-subquery-column-title").text(m.getResText("SubQueryColumnTitle")).appendTo(e);
            var j = a("<div></div>").addClass("eqjs-qp-ve-subquery-column-element").appendTo(e);
            m._columnElement = a("<a></a>").attr("href", "javascript:void(0)").appendTo(j);
            m._columnElement.click(function(n) {
                d.PopupMenu("showMenu", {
                    anchor: m._columnElement,
                    selectedIds: null,
                    itemSelectedCallback: function(o, q) {
                        return m._columnElementMenuClick(o, q)
                    }
                })
            });
            var g = a("<div></div>").addClass("eqjs-qp-ve-subquery-qp-caption").text(m.getResText("SubQueryQueryPanelCaption")).appendTo(m._dialogBlock);
            m._queryPanelBlock = a('<div class="eqjs-qp-ve-subquery-qp"></div>').appendTo(m._dialogBlock);
            var c = m.options.parentWidget.element.attr("id");
            if (c) {
                m._queryPanelBlock.attr("id", c + "-SubQueryPanel")
            }
            m._dialogBlock.dialog({
                autoOpen: false,
                draggable: false,
                resizable: false,
                title: m.getResText("SubQueryDialogTitle"),
                dialogClass: "eq-js-dialog",
                closeText: "X",
                modal: true,
                width: k.options.subQueryDialogWidth,
                minHeight: k.options.subQueryDialogHeight,
                zIndex: k.options.dialogZIndex,
                buttons: [{
                    name: "eqjs-subquery-button-ok",
                    text: m.getResText("ButtonOK"),
                    click: function() {
                        var o = m.getSubQuery();
                        m._expr.value = o.getObject();
                        a(this).dialog("close");
                        var n = m.getQuery();
                        n.fireChangedEvent({
                            source: m.getQueryPanel(),
                    ...
                    text: m.getResText("ButtonCancel"),
                    click: function() {
                        a(this).dialog("close")
                    }
                }],
                ...
                close: function(n, o) {
                    m._queryPanelBlock.QueryPanel("destroy")
                }
            })
        },
...
(function(a, b) {
    a.widget("eqjs.ColumnsContainer", {
        ...
        _render: function() {
            ...
            if (k && !k.isEmpty()) {
                n.options.entitiesList = k.getEntitiesTree({
                    ...
                    addUIR: true,
                    addUIS: false,
                    attrPlacement: n.options.attrPlacement,
                    sortEntities: n.options.sortEntities
                });
        ...
        _addColumnElement: function(c, h, e) {
            var d = this;
            var f = a("<div></div>");
            var i = c.find("[class*=" + d._getCssPrefix() + "-row]");
            if (e == 0) {
                f.prependTo(c)
            } else {
                if (e > 0 && e < i.length - 1) {
            ...
            if (!h.blockId) {
                this.trySetBlockId(h)
            }
            if (h.blockId) {
                f.attr("id", h.blockId)
            }
            var g = "element.ColumnRow_" + h.expr.typeName + "({columnsPanel: self}); element.ColumnRow_" + h.expr.typeName + "('init', column);";
            var j = new Function("self, element, column", g);
            j(d, f, h)
        },
        _refreshByQuery: function(l) {
            var s = this;
            if (!this.getQuery()) {
                return
            }
            var e = a("<div></div>"),
                f = a("<div></div>");
            var h = this._getCssPrefix();
            e.addClass(h + "-columns");
            e.appendTo(f);
            f.appendTo(s.element);
            if (l) {
                e.hide()
            }
            var g = s.getColumns();
            var r = g.length;
            for (var j = 0; j < r; j++) {
                s._addColumnElement(e, g[j])
            }
            var i, q, c, d = false,
                m = false,
                n, o = false;
            var k = s.getModel();
            if (s.options.allowDragDrop) {
                e.sortable({
                    containment: f,
                    tolerance: "pointer",
                    axis: "y",
                    ...
                    start: function(t, u) {
                        i = u.item.index();
                        u.item.addClass(h + "-column-sort");
                        o = true
                    },
                    update: function(v, w) {
                        var u = w.item.attr("data-id");
                        if (u) {
                            var t = k.getAttributeById(u);
                            if (t.uir != true) {
                                w.item.remove();
                                return
                            }
                    ...
                    stop: function(t, u) {
                        u.item.removeClass(h + "-column-sort");
                        o = false;
                        return true
                    }
                });
                s.element.droppable({
                    ...
                    over: function(t, v) {
                        v.helper.addClass(h + "-column-drag");
                        var u = v.draggable.attr("data-id");
                        if (!k.checkAttrProperty(u, "uir")) {
                            v.helper.addClass(h + "-column-drag-forbidden")
                        }
                    },
                    out: function(t, u) {
                        u.helper.removeClass(h + "-column-drag");
                        u.helper.removeClass(h + "-column-drag-forbidden")
                    },
                    activate: function(t, u) {
                        n = u.draggable.attr("data-id")
                    }
                })
            }
            return e
        ...
        addColumn: function(g, e) {
            ...
            if (!g || (a.isArray(g) && g.length == 0)) {
                return
            }
            h.addColumn(g, e, d);
            var c = d.element.find("[class*=" + d._getCssPrefix() + "-columns]");
            if (c.length > 0) {
                if (g.length) {
                    var f;
                    for (f = 0; f < g.length; ++f) {
                        d._addColumnElement(c, g[f], e + f)
                    }
                } else {
                    d._addColumnElement(c, g, e)
                }
            } else {
                d.refresh()
            }
        ...
        removeColumn: function(f) {
            ...
            if (d >= 0) {
                h.removeColumn(f, c);
                var i = this.element.find("[class*=" + g + "-row]").filter(function(j) {
        ...
        _moveColumn: function(i, h) {
            ...
            var c = d.element.find("[class*=" + d._getCssPrefix() + "-columns]");
            var f = c.find("[class*=" + d._getCssPrefix() + "-row]");
            var e = a(f[i]);
            if (h == 0) {
                e.prependTo(c)
            } else {
    ...
    a.widget("eqjs.ColumnRow_ENTATTR", a.eqjs.ColumnRow, {
        ...
        _getBaseExpr: function() {
            ...
            if (c._column.enabled !== false && !c._column.readOnly) {
                d = a("<a></a>").attr("href", "javascript:void(0)").text(c._getAttributeText(c._baseAttr)).attr("title", c._getAttributeText(c._baseAttr)).click(function(f) {
                    f.preventDefault();
                ...
                d = a("<span></span>").text(c._getAttributeText(c._baseAttr)).attr("title", c._getAttributeText(c._baseAttr))
            }
            return d
        },
        _fillBaseBlock: function(d) {
            var c = this;
            d.addClass(this._panelCssPrefix + "-expr-block");
            c._baseExprBlock = a("<div></div>").addClass(this._panelCssPrefix + "-colelement").addClass(this._panelCssPrefix + "-attrelement").appendTo(d);
            var e = c._getBaseExpr();
            e.appendTo(c._baseExprBlock);
            if (!c._column.readOnly) {
                c._createFunctionMenu()
            }
        },
        _refreshByColumn: function() {
            ...
            var e = a("<div></div>").appendTo(c.element);
            c._fillBaseBlock(e);
            ...
            if (c.options.columnsPanel.options.showColumnCaptions) {
                ...
                if (!c._column.readOnly) {
                    this._captionEditorBlock = a("<div></div>");
                    this._captionEditorBlock.appendTo(this.element);
                    var f = function() {
                        c._column.captionChanged = true;
                        c._fireColumnChange("change")
                    };
                    this._captionEditorBlock.ColumnRow_CaptionEditor({
                        parentWidget: c,
                        cssClassPrefix: this._panelCssPrefix
                    });
                    this._captionEditorBlock.ColumnRow_CaptionEditor("init", c._column, c._column.caption, f)
                } else {
                    var d = a("<span></span>").addClass(this._panelCssPrefix + "-colelement").addClass(this._panelCssPrefix + "-captionelement").text(c._column.caption).attr("title", c._column.caption).appendTo(this.element)
                }
            }
            c.adjustActiveClass()
        },
        _getDefaultTitleText: function(c) {
            var e = this.options.columnsPanel;
            var f = e.options.titleElementFormat || e.options.attrElementFormat;
            var d = this.getModel();
            return d.getAttributeText(c, f)
        },
        ...
        _changeTypeToCustomSql: function() {
            var d = this;
            var h = d._column.expr.id;
            d._column.caption = "";
            var c = "";
            var e = d.getModel();
            if (e) {
                c = e.getAttributeById(h).sqlExpr
            }
            d._column.expr = {
                sql: c,
                baseAttrId: h,
            ...
            d.destroy();
            d._clear();
            d.element.ColumnRow_CUSTOMSQL({
                columnsPanel: d.options.columnsPanel
            });
            d.element.ColumnRow_CUSTOMSQL("init", g);
            d._fireColumnChange("change");
            if (f) {
                d.options.columnsPanel._activeColumn = null;
                d.element.ColumnRow_CUSTOMSQL("makeActive")
            }
            d.element.ColumnRow_CUSTOMSQL("showSqlEditor")
        },
        _createFunctionMenu: function() {
            var m = this;
            var g = [];
            var c = m.getModel().getAggrFunctions();
            var d = true;
            var i = true;
            var l = null;
            var e = m._getAttribute();
            var h;
            var k = c.length;
            for (var j = 0; j < k; j++) {
                if (!c[j]) {
            ...
            if (!i) {
                m._column.expr.func = g[0].id
            }
            if (m.options.columnsPanel.options.allowCustomExpressions) {
                l = {
                    id: "CustomSqlDivider",
                    text: "---"
                };
                g.push(l);
                h = EQ.core.getText("CustomExpression");
                l = {
                    id: "CUSTOMSQL",
                    text: h
                };
            ...
            m._menuFunctionsBlock = a("<div></div>").hide().appendTo(m.element);
            var f = m.element.attr("id");
            if (f) {
                f += "-FunctionsMenu"
            }
            m._menuFunctionsBlock.PopupMenu({
                items: g,
                id: f,
                domWriteItemsId: m.options.columnsPanel.options.domWriteItemsId
            });
            return m._menuFunctionsBlock
        },
        _showButtons: function() {
                    ...
                    if (c.options.columnsPanel.options.allowAggrColumns !== false && c._column.enabled !== false) {
                        ...
                        c._menuFunctionsBlock.PopupMenu("showMenu", {
                            ...
                            itemSelectedCallback: function(e, f) {
                                if (f.menuItem.id == "CUSTOMSQL") {
                                    c._changeTypeToCustomSql()
                                } else {
...
(function(a, b) {
    a.widget("eqjs.ColumnRow_AGGRFUNC", a.eqjs.ColumnRow_ENTATTR, {
        ...
        _fillBaseBlock: function(e) {
            ...
            var g, d;
            var k = a("<div></div>").addClass(this._panelCssPrefix + "-colelement").addClass(this._panelCssPrefix + "-aggrfuncelement");
            if (m._column.enabled !== false && !m._column.readOnly) {
                d = a("<a></a>", {
                    href: "javascript:void(0)"
                }).appendTo(k);
                m._createFunctionMenu()
            } else {
                d = a("<span></span>").appendTo(k)
            }
            var i = m.getModel().getAggrFunctionFormat(m._column.expr.func);
            if (!i || i === "") {
                return
            }
            var c = m._parseDisplayFormat(i);
            if (c.length === 0) {
                return
            }
            var l = null;
            ...
            for (var h = 0; h < f; h++) {
                ...
                if (l.type === "function") {
                    d.text(l.text);
                    k.appendTo(e);
                    if (m._column.enabled !== false) {
                        d.click(function(n) {
                            m._menuFunctionsBlock.PopupMenu("showMenu", {
                                anchor: d,
                                selectedIds: null,
                                itemSelectedCallback: function(o, q) {
                                    m._column.expr.func = q.menuItem.id;
                                    m._column.caption = "";
                                    m.refresh();
                                    m._fireColumnChange("change");
                                    return false
                                }
                            })
                        })
                    ...
                    if (l.type === "attribute") {
                        m._baseAttr = m._getAttribute();
                        g = this._getBaseExpr();
                        m._baseExprBlock = a("<div></div>").addClass(this._panelCssPrefix + "-colelement").addClass(this._panelCssPrefix + "-attrelement").appendTo(e);
                        g.appendTo(m._baseExprBlock)
                    } else {
                        if (l.type === "text") {
                            var j = a("<span></span>").addClass(this._panelCssPrefix + "-colelement").text(l.text).attr("title", l.text).appendTo(e)
                        }
                    }
                }
            }
...
(function(a, b) {
    a.widget("eqjs.ColumnRow_CUSTOMSQL", a.eqjs.ColumnRow_ENTATTR, {
        _fillBaseBlock: function(e) {
            var c = this;
            e.addClass(this._panelCssPrefix + "-expr-block");
            c._baseExprBlock = a("<div></div>").addClass(this._panelCssPrefix + "-colelement").addClass(this._panelCssPrefix + "-attrelement").appendTo(e);
            var d = function() {
                c._fireColumnChange("change");
                c._changeCaption()
            };
            c._column.captionChanged = false;
            c._baseExprBlock.ColumnRow_CustomSqlExprEditor({
                parentWidget: c,
                cssClassPrefix: this._panelCssPrefix
            });
            c._baseExprBlock.ColumnRow_CustomSqlExprEditor("init", c._column, c._getExprText(), d)
        },
        ...
        _getExprText: function() {
            var e = this._column.expr.sql;
            var d = this.getModel();
            if (d) {
                var c = d.getAttributeById(this._column.expr.baseAttrId);
                e = e.replace(new RegExp(c.sqlExpr, "g"), this._getAttributeText(c))
            }
            return e
        },
        _getDefaultCaption: function() {
        ...
        _changeTypeToSimple: function() {
            var c = this;
            var f = c._column.expr.baseAttrId;
            c._column.caption = "";
            c._column.expr = {
                typeName: "ENTATTR",
                id: f
...
(function(a, b) {
    a.widget("eqjs.ColumnRow_CustomSqlExprEditor", a.eqjs.ValueEditor_EDIT, {
        _column: null,
        _defaultValue: "",
        _editBoxClass: "eqjs-qc-ce-editbox",
        _onChange: null,
        ...
        init: function(e, c, d) {
            this._editBoxClass = this.options.cssClassPrefix + "-ce-editbox";
            this._expr.value = e.expr.sql;
            this._expr.text = e.expr.sql;
            this._column = e;
            this._defaultValue = c;
            this._onChange = d;
            this.refresh()
    ...
    a.widget("eqjs.EntitiesPanel", {
        ...
        _render: function() {
            ...
            if (f != null && !f.isEmpty()) {
                ...
                d = this.element.append(this._renderEntity(c, this._rootEntityBlock, 0))
            }
            if (this.options.showFilterBox) {
                this._createFilterBox(d)
            } else {
                this._rootEntityBlock.css("top", "0")
            }
            if (this.options.showToolbar) {
                this._createToolPanel(d)
            } else {
                this._rootEntityBlock.css("bottom", "0")
            }
            this._renderProgressBlock()
        },
        _renderEntity: function(o, m, l) {
            var r = this;
            var q = "eqjs-ep-entity",
                h, f = a("<div></div>", {
                    "class": q + "-node"
                }),
                s = a("<div></div>", {
                ...
                n, k, v, x, t, w, g = a("<div></div>"),
                B = l;
            var c = function(D, i) {
                var j = i.find("." + q + '-attr[data-id="' + D + '"]');
                return j.length > 0
            };
            var d = function(i) {
                return (r.options.showAttributes.usedInConditions && i.uic) || (r.options.showAttributes.usedInColumns && i.uir) || (r.options.showAttributes.usedInSorting && i.uis)
            };
            if (m) {
                h = m;
                h.html("").addClass(q)
            ...
            if (o.id && o.id != "") {
                y.text(o.text).appendTo(f);
                if (r.options.showCheckboxes) {
                    y.prepend(C)
                }
                e.prependTo(f);
                if (r.options.showTooltips && o.description) {
                    y.attr("title", o.description)
                }
                for (var v = 0; v < B; v++) {
                    f.prepend(a("<div></div>", {
                        "class": q + "-offset"
            ...
            var A = o.items ? o.items.length : 0;
            for (var v = 0; v < A; v++) {
                var z = o.items[v];
                if (z.isEntity) {
                    s.append(r._renderEntity(z, null, B))
                } else {
                    if (!z.lookupAttr || !(c(z.lookupAttr, s) || c(z.lookupAttr, this._rootEntityBlock))) {
                        k = a("<label></label>", {
                            text: z.text,
                            "class": q + "-attr-label"
                        });
                        if (r.options.showCheckboxes) {
                            k.prepend('<input type="checkbox" />')
                        }
                        if (r.options.showTooltips && z.description) {
                            k.attr("title", z.description)
                        }
                        for (var u = 0; u < B + 1; u++) {
                            k.prepend(a("<div></div>", {
                                "class": q + "-offset"
                        ...
                        n = a("<div></div>").attr("class", function() {
                            var i = q + "-attr ";
                            if (f.html().length == 0) {
                                i += q + "-attr-root"
                            }
                            return i
                        }).html(k).attr("data-id", z.id);
                        if (r.options.draggableAttributes) {
                            n.draggable({
                        ...
                        if (r.options.clickableAttributes == 1) {
                            n.click(function() {
                                var i = a("#" + r.options.queryPanelId);
            ...
            if (s.html().length) {
                ...
                e.click(function(i) {
                    s.toggle();
                    a(this).toggleClass(q + "-node-button-open");
                    i.preventDefault()
                })
            }
            if (s) {
                s.find("label input").click(function(i) {
            ...
            C.click(function() {
                if (a(this).prop("checked")) {
                    s.find("label input").prop("checked", true)
                } else {
                    s.find("label input").prop("checked", false)
                }
            });
            return h
        },
        ...
        _createToolPanel: function(d) {
            ...
            if (this.options.showSelectAllButton) {
                g.attr("title", EQ.core.getText("ButtonSelectAll"));
                j.append(g)
            }
            if (this.options.showClearSelectionButton) {
                c.attr("title", EQ.core.getText("ButtonDeselectAll"));
                j.append(c)
            }
            k.attr("title", EQ.core.getText("ButtonAddColumns"));
            e.attr("title", EQ.core.getText("ButtonAddConditions"));
            i.append(k, e);
            m.append(j, i);
            g.click(function() {
