    ...
    public class AccountController : ApartmentAppsApiController
    {
        ...
        public async Task<UserInfoViewModel> GetUserInfo(string devicePlatform = null, string devicePushToken = null)
        {
            ...
            return new UserInfoViewModel
            {
                ...
                ImageUrl = _blobStorage.GetPhotoUrl(CurrentUser.ImageUrl) ?? $"http://www.gravatar.com/avatar/{HashEmailForGravatar(CurrentUser.Email.ToLower())}.jpg",
                ImageThumbnailUrl = _blobStorage.GetPhotoUrl(CurrentUser.ImageThumbnailUrl) ?? $"http://www.gravatar.com/avatar/{HashEmailForGravatar(CurrentUser.Email.ToLower())}.jpg",
